...
struct ENEMY
{
	...
	int type;        //タイプ
	int img;         //画像
	int x, y, w, h;  //座標 x,y 幅 w 高さ h
	int speed;       //移動速度
	int point;       //スコア加算
};
//敵機
struct ENEMY  g_enemy[ENEMY_MAX];
struct ENEMY  g_enemy00 = { TRUE,0,0,0,-45,50,110,0,1 };   //元{TRUE,0,0,0,-50,63,120,0,1}
...
void PlayerControl()
{
	...
	DrawFormatString(510, 220, 0x000000, "走行距離");
	DrawFormatString(555, 240, 0xFFFFFF, "%08d", g_Mileage/10);
	DrawFormatString(510, 260, 0x000000, "スピード");
